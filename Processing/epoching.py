...
class Config:
    ...
    # Baseline y umbral
    baseline_window_sec: float = 20.0   # Usado si use_rolling_baseline = False
...
def rolling_baseline_stats(signal, fs, window_sec, min_frac=0.25):
    # Baseline movil (rolling median + MAD)
...
def refine_consensus_events(consensus_events, df, time, fs, cfg):
    # Aplica el refinamiento local a cada evento de consenso, canal por canal y combina el resultado
